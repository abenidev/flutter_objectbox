...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 1301644856542467462),
      name: 'Person',
      lastPropertyId: const IdUid(3, 472685549694140022),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 4554915031480991752),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 605657994076059309),
            name: 'firstName',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 472685549694140022),
            name: 'lastName',
            type: 9,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 1301644856542467462),
